          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-300/30 p-8">
                ...
                <div className="bg-[#8C2221] font-semibold p-12 border border-gray-300/30">
                  <div className="text-[#F3EDED] space-y-6">
                    ...
                    <div className="flex items-center gap-8 mt-8">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-2xl font-gaisyr italic">Devi</div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-gray-300 rounded-full"></div>
                        <div className="text-2xl font-gaisyr italic">Jianna</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <tr>
              <td className="border border-gray-300/30 p-8">
                ...
                <div className="bg-[#B7C2DD] p-12 text-center border border-gray-300/30">
                  <h2 className="text-[#533E3D] text-4xl mb-8 font-gaisyr">
                    Want to chat about your document processing challenges?
                  </h2>
                  <div className="flex justify-center gap-4">
                    <button className="bg-[#8C2221] text-white px-8 py-3 font-semibold hover:bg-[#6d2421] transition-colors">
                      Try it now
                    </button>
                    <button className="bg-white text-[#533E3D] px-8 py-3 font-semibold border border-gray-300 hover:bg-gray-100 transition-colors">
                      Contact us
                    </button>
                  </div>
                </div>
